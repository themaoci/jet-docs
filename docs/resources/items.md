...
To find specific item IDs, you can use either the [Tarkov Database](https://tarkov-database.com/) or [EFT Search Engine Panopticon](https://eft.justemutarkov.eu/) which allows to search more then just items now.
